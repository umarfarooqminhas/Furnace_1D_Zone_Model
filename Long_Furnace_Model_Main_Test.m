...
%% Stock Temperature Profile Plotting
plot(Temp_stock,'b','LineWidth',2.0);
hold on;
plot(Temp_stock_mid,'k','LineWidth',2.0);
xlabel('Stock Position')
ylabel('Temperature (K)')
legend('Top/Bottom Surface','Middle Surface')
title('Stock Temperature Profile')