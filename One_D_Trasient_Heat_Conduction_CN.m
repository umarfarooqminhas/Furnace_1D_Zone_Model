function T4 = One_D_Trasient_Heat_Conduction_CN(fa,fb,Tin,t)
...
% Inputs
alpha = 2e-5; % Thermal diffusivity, m2/s (Heat Conduction - Ozisik & Hahn)
kt = 27; % Thermal Conductivity, W/(m K)
%t = 720; % total time, s eg t = 100, 2000
nt = 1000; % total no. of time steps, nt = 1, 200
delta_t=t/nt; % timestep, s
xlength= 0.2; % xlength, m
